-- ============================================
-- RECREAR BD_BigData_Relacional_Errores
-- Con todas las tablas y datos completos
-- ============================================

IF DB_ID('BD_BigData_Relacional_Errores') IS NULL
BEGIN
...
DROP TABLE IF EXISTS dbo.CanalVenta;
DROP TABLE IF EXISTS dbo.EstadoVenta;
...
DROP TABLE IF EXISTS dbo.CatalogoErroresEsperados;
GO
...
PRINT '✓ Clientes insertados (1205 registros)';
...
PRINT '✓ Ventas y detalles insertados (10000 registros)';
...
UNION ALL
    SELECT 'CatalogoErroresEsperados', COUNT(*)
    FROM dbo.CatalogoErroresEsperados
ORDER BY Tabla;
GO
